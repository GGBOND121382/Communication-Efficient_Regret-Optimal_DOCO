...
def run_comm():
    ...
    if 'epsilon' in filename and number_of_clients == 32:
        comm_upp_bnd = 11000
    elif 'epsilon' not in filename and number_of_clients == 32:
        comm_upp_bnd = 16000
    elif 'epsilon' in filename and number_of_clients == 8:
        comm_upp_bnd = 30000
    else:
        comm_upp_bnd = 36000

    for comm_bueget in comm_budget_list:
        if (comm_bueget < 372 and number_of_clients == 32):
            continue
