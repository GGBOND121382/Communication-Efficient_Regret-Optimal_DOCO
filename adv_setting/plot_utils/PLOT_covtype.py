...
def plot_adv_32_8(src_dirname_8, src_dirname_32, dst_name='', format='png'):
    filename = "covtype.libsvm.binary"
    labels = ["non-pri", "non-comm", "PDOM"]


    # color = ["#4285F4", '#def442', 'xkcd:red']
    # color_light = ["#4285F4", '#def442', 'xkcd:red']
    # color_dark = ["#4285F4", '#def442', 'xkcd:red']
    ...
    # color_dark = ["#4285F4", '#fbbc05', 'xkcd:red']
    ...
    plt.plot(comm_budget_list_DOCO, DOCO_gossip_err_mean, '-', linewidth=param_linewidth+1.,
    ...
    plt.plot(comm_budget_list_DOCO, DBOCG_err_mean, '-', linewidth=param_linewidth+1,
             markersize=param_markersize_, c=color[0], label='D-BOCG')
    ...
    comm_budget_list_TDOCO = [i for i in range(600, 6000, 600)] + [i for i in range(6000, 36000, 6000)]
    ...
    plt.plot(comm_budget_list_DOCO, DBOCG_err_mean, '--', linewidth=param_linewidth+0,
             markersize=param_markersize_, c=color[0], label='D-BOCG')
    ...
    #
    #
    plt.title("($\mathtt{a}$) ${\\mathrm{covtype}}$ ($\mathtt{cycle}$)", y=-0.55,
              # font={'family':'Helvetica'},
              fontsize=35)
    # , font={'family':'Symbol', 'size':25}
...
if __name__ == '__main__':
    ...
    dst_name = filename.replace('.', '_') + '_adv'
    # plot_stoc(src_dir_name, dst_name + '.png', format='png')
    plot_adv_32_8(src_dir_name_8, src_dir_name_32, dst_name + '.pdf', format='pdf')
