...
def plot_adv(src_dir_name, dst_name, format='png'):
    ...
    plt.plot(comm_budget_list_DOCO, DBOCG_err_mean, '--', linewidth=param_linewidth+2,
...
def plot_adv_32_8(src_dirname_8, src_dirname_32, dst_name='', format='png'):
    ...
    # legend1 = plt.legend(handles=patches, handletextpad=0.1, columnspacing=0.4, bbox_to_anchor=(0.82+0.26, 1.36), ncol=3, frameon=False, fontsize=23)
    ...
    plt.xlabel("Communication Budget", fontsize=23)
    plt.ylabel("Error Rate", fontsize=23)
    # plt.title("(b) ${\\mathtt{epsilon}}$ (cycle)", y=-0.5, font={'family': 'Helvetica', 'size': 27})
