...
def draw_trend_image_test(ax1,
                          cycle_json_fn, clique_json_fn
                          # err_cyc, err_clique,
                          # image_file_name='test_result_trend.png'
                          ):
    ...
    ######
    ax2.plot(x, comm_budget_CP_cyc, '-', marker='o', color=cyc_color, linewidth=param_linewidth,
             markerfacecolor='white', markeredgewidth=2,
             markersize=param_markersize_)
    ax2.plot(x, comm_budget_DMA_cyc, ':', marker='v', color=cyc_color, linewidth=param_linewidth,
             markerfacecolor='white', markeredgewidth=2,
             markersize=param_markersize_)
    ax2.plot(x, comm_budget_AGD_cyc, '--', marker='^', color=cyc_color, linewidth=param_linewidth,
             markerfacecolor='white', markeredgewidth=2,
             markersize=param_markersize_)
    ######
    ######
    ax2.plot(x, comm_budget_CP_clique, '-', marker='o', color=clique_color, linewidth=param_linewidth,
             markerfacecolor='white', markeredgewidth=2,
             markersize=param_markersize_)
    ax2.plot(x, comm_budget_DMA_clique, ':', marker='v', color=clique_color, linewidth=param_linewidth,
             markerfacecolor='white', markeredgewidth=2,
             markersize=param_markersize_)
    ax2.plot(x, comm_budget_AGD_clique, '--', marker='^', color=clique_color, linewidth=param_linewidth,
             markerfacecolor='white', markeredgewidth=2,
             markersize=param_markersize_)
    ######
