...
import non_iid_setting.plot_utils.PLOT_epsilon
import non_iid_setting.plot_utils.PLOT_covtype
import non_iid_setting_clique.plot_utils.PLOT_covtype_clique
import non_iid_setting_clique.plot_utils.PLOT_epsilon_clique

# import TDOCO_pure_plot_adv_32
import adv_setting.plot_utils.PLOT_covtype
import adv_setting.plot_utils.PLOT_epsilon
import adv_setting_clique.plot_utils.PLOT_covtype_clique
import adv_setting_clique.plot_utils.PLOT_epsilon_clique
...
def draw(data_filename):
    ...
    plt.figure(figsize=(6.5 * 4 + 3, 3.49 * 2 + 2.7))
    ...
    if(data_filename == 'all' or data_filename == 'covtype.libsvm.binary'):
        ...
        adv_setting.plot_utils.PLOT_covtype.plot_adv_32_8(src_dir_name_8, src_dir_name_32)
    ...
    if (data_filename == 'all' or data_filename == 'epsilon_normalized.all'):
        ...
        adv_setting.plot_utils.PLOT_epsilon.plot_adv_32_8(src_dir_name_8, src_dir_name_32)
    ...
    if (data_filename == 'all' or data_filename == 'covtype.libsvm.binary'):
        ...
        src_dir_name_8 = 'plot_data_cov_8/'
        # plot_stoc(src_dir_name, dst_name + '.png', format='png')
        adv_setting_clique.plot_utils.PLOT_covtype_clique.plot_adv_32_8(src_dir_name_8, src_dir_name_32)
    ...
    if (data_filename == 'all' or data_filename == 'epsilon_normalized.all'):
        ...
        src_dir_name_8 = 'plot_data_eps_8/'
        # plot_stoc(src_dir_name, dst_name + '.png', format='png')
        adv_setting_clique.plot_utils.PLOT_epsilon_clique.plot_adv_32_8(src_dir_name_8, src_dir_name_32)

    patches = [mpatches.Patch(color=color_light[i], label="{:s}".format(labels[i])) for i in [1, 0, 2]]
    ...
    if (data_filename == 'all' or data_filename == 'covtype.libsvm.binary'):
        ...
        src_dir_name_8 = 'plot_data_cov_8/'
        # plot_stoc(src_dir_name, dst_name + '.png', format='png')
        non_iid_setting.plot_utils.PLOT_covtype.plot_stoc_32_8(src_dir_name_8, src_dir_name_32, dst_name='non_iid_setting')
    ...
    if (data_filename == 'all' or data_filename == 'epsilon_normalized.all'):
        ...
        src_dir_name_8 = 'plot_data_eps_8/'
        # plot_stoc(src_dir_name, dst_name + '.png', format='png')
        non_iid_setting.plot_utils.PLOT_epsilon.plot_stoc_32_8(src_dir_name_8, src_dir_name_32, dst_name='non_iid_setting')
    ...
    if (data_filename == 'all' or data_filename == 'covtype.libsvm.binary'):
        ...
        src_dir_name_8 = 'plot_data_cov_8/'
        # plot_stoc(src_dir_name, dst_name + '.png', format='png')
        non_iid_setting_clique.plot_utils.PLOT_covtype_clique.plot_stoc_32_8(src_dir_name_8, src_dir_name_32,
                                                                             dst_name='non_iid_setting_clique')
    ...
    if (data_filename == 'all' or data_filename == 'epsilon_normalized.all'):
        ...
        src_dir_name_8 = 'plot_data_eps_8/'
        # plot_stoc(src_dir_name, dst_name + '.png', format='png')
        non_iid_setting_clique.plot_utils.PLOT_epsilon_clique.plot_stoc_32_8(src_dir_name_8, src_dir_name_32,
                                                                             dst_name='non_iid_setting_clique')
    ...
    fig = plt.gcf()
    # fig.tight_layout()
    fig.savefig("DOCO_adv_stoc_varying_comm.pdf", format="pdf", bbox_inches="tight", pad_inches=0.2)
