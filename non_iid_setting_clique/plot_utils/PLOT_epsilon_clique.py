...
def plot_stoc_32_8(src_dirname_8, src_dirname_32, dst_name, format='png'):
    ...
    if ('non' in dst_name):
        plt.title("($\\mathtt{h}$) ${\\mathrm{epsilon}}$ ($\\mathtt{clique}$)", y=-0.55,
...
if __name__ == '__main__':
    ...
    src_dir_name = '32-merge-data/iid_setting_clique/'
    dst_name = filename.replace('.', '_') + '_iid'
    # plot_stoc(src_dir_name, dst_name + '.png', format='png')
    plot_stoc_32(src_dir_name, dst_name + '_clique.pdf', format='pdf')

    src_dir_name = '32-merge-data/non_iid_setting_clique/'
    dst_name = filename.replace('.', '_') + '_non_iid'
    # plot_stoc(src_dir_name, dst_name + '.png', format='png')
    plot_stoc_32(src_dir_name, dst_name + '_clique.pdf', format='pdf')
    '''
